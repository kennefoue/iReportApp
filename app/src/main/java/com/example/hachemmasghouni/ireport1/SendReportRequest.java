...
public class SendReportRequest extends StringRequest{
    ...
    public SendReportRequest(double lat, double lon, String ref, ArrayList<String> imagesNamesList, Response.Listener<String> listener) throws SQLException {
        super(Request.Method.POST, SEND_REPORT_REQUEST_URL, listener, null);
        params = new HashMap<>();
        ReportDataObject reportObject = new ReportDataObject(1, lat, lon, ref, imagesNamesList);
